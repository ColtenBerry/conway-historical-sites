...
final ThemeData adminPageTheme = ThemeData(
  ...
  //   dayStyle: TextStyle(color: Color.fromARGB(255, 76, 32, 8)),
  //   dayForegroundColor: WidgetStatePropertyAll(Color.fromARGB(255, 76, 32, 8)),

  //   yearForegroundColor: WidgetStatePropertyAll(Color.fromARGB(255, 76, 32, 8)),
  //   dividerColor: (Color.fromARGB(255, 76, 32, 8)),
  ...
  //           textStyle:
  //               const TextStyle(color: Color.fromARGB(255, 76, 32, 8))))),
  //   headerForegroundColor: Color.fromARGB(255, 76, 32, 8),
  // ),
